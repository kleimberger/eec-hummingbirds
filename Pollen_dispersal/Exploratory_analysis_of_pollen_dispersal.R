...
digitized_points <- read.csv("C:\\Users\\leimberk\\Box\\Biol_Reviews_Analyses\\Pollen_dispersal\\Fitting_dispersal_curves\\export\\Digitized_pollen_dispersal_data.csv")
