...
papers = read.csv("data/hummingbird_papers_over_time/Web_of_science_search_results_20200904.csv")
...
#As PDF
pdf(file = "results/hummingbird_papers_over_time/Intersection_plot.pdf", onefile = FALSE, width = 11, height = 8.5) # or other device
upset_plot
dev.off()

#As PNG
png(file = "results/hummingbird_papers_over_time/Intersection_plot.png", width = 11, height = 8.5, units = "in", res = 300) # or other device
upset_plot
dev.off()
...
#Export
ggsave("results/hummingbird_papers_over_time/Papers_over_time_lines_labeled_gray.png", plot_line_with_labels, width = 10, height = 7.5, units = c("in"), dpi = 300)
