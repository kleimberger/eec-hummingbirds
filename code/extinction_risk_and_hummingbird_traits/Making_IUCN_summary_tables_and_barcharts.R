...
iucn_data <- read.csv( "data/extinction_risk_and_hummingbird_traits/Hummingbird_IUCN_and_trait_data_with_derived_vars_20210518.csv") %>%
...
write.csv(fd_status_sum, "results/extinction_risk_and_hummingbird_traits/IUCN_Status_Summary.csv")
write.csv(fd_pop_sum, "results/extinction_risk_and_hummingbird_traits/IUCN_Population_Summary.csv")
write.csv(clade_status_sum, "results/extinction_risk_and_hummingbird_traits/IUCN_Status_Summary_by_Clade.csv")
write.csv(clade_pop_sum, "results/extinction_risk_and_hummingbird_traits/IUCN_Population_Summary_by_Clade.csv")
...
#Export
ggsave(filename = "results/extinction_risk_and_hummingbird_traits/IUCN_extinction_risk_multiplot_rdylbu.png", plot = fd_clade_multiplot, device = "png", width = 10, height = 12, units = "in", bg = "white")
